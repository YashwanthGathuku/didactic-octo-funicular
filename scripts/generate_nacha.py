...
def generate_nacha_file(num_entries: int, total_amount_cents: int, output_path: str):
    ...
    batch_header = (
        ...
        "PAYROLL   "                    # Company Entry Description (10)
        f"{file_date}"                  # Company Descriptive Date (6)
        f"{effective_date}"             # Effective Entry Date (6)
        "   "                           # Settlement Date (3 spaces - Julian populated by Fed)
    ...
    batch_control = (
        ...
        f"{total_credit_cents:012d}"    # Total Credit Amount (12)
        "1234567890"                    # Company Identification (10)
    ...
    print(f"[OK] Generated valid synthetic NACHA file: {output_path}")
...
if __name__ == "__main__":
    ...
    generate_nacha_file(args.entries, args.amount_cents, args.output)
