...
| **7** | **State-Machine & Dual-Control Rules** | **PASS** | P0 | Identity-bound dual-control approval with cryptographic artifact and policy integrity binding in [`internal/review/release.go`](file:///c:/Users/Gathu/Projects/fintech/gateway/internal/review/release.go). Self-approval blocked in [`threat_model_test.go`](file:///c:/Users/Gathu/Projects/fintech/gateway/threat_model_test.go#L51-L60). |
...
| `README.md` | "Dual-Control Human Release requires two distinct human operators" | [`gateway/internal/review/release.go`](file:///c:/Users/Gathu/Projects/fintech/gateway/internal/review/release.go); [`threat_model_test.go`](file:///c:/Users/Gathu/Projects/fintech/gateway/threat_model_test.go#L51-L60) | **VERIFIED (PASS)** |
