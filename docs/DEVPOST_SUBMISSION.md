...
| `live_google_memory_bank` | **IMPLEMENTED** | `ai-tier/memory/google_provider.py` | REST client for Google Agent Platform Memory Bank v1beta1; ADC verified locally, live API execution on standby awaiting cloud credit activation |
| `live_ingest_events` | **IMPLEMENTED** | `ai-tier/memory/google_provider.py` | Managed IngestEvents client pipeline; ADC verified locally, live API execution on standby awaiting cloud credit activation |
| `live_memory_profiles` | **IMPLEMENTED** | `ai-tier/memory/google_provider.py` | Managed RetrieveProfiles client pipeline; ADC verified locally, live API execution on standby awaiting cloud credit activation |
