...
from contracts.manifests import FIXED_AGENT_ROSTER, AgentManifest, validate_agent_roster_membership
...
NACHA_RETURN_CODES = {
    ...
    "R23", "R24", "R29", "R31", "R33", "R80", "R81", "R82", "R83", "R84", "R85"
}
...
def run_return_risk_adversarial_evals(
    ...
    manifest = FIXED_AGENT_ROSTER.get("ReturnRiskAgent", AgentManifest(
    ...
    for item in scenarios:
        ...
        if scenario_id == "ADV-RET-001":
            ...
            checks.append(ReturnCheckOutcome(
        ...
        # =========================================================================
            ...
            calc = MockReturnRiskEngine.calculate_score(r01_volume=90.0, velocity_surge=80.0, cutoff_variance=70.0)
            checks.append(ReturnCheckOutcome(
        ...
        # =========================================================================
            ...
            idempotency_key = hashlib.sha256(
                f"{payload['tenant_id']}:{payload['trace_number']}:{payload['event_id']}".encode("utf-8")
            ).hexdigest()
