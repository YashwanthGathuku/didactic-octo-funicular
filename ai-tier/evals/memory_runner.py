...
def run_memory_adversarial_evals(
    ...
    for item in scenarios:
        ...
        if scenario_id == "ADV-MEM-001":
            ...
            memory_claim = "ALLOW"
            final_decision = deterministic_policy if deterministic_policy == "DENY" else memory_claim
            checks.append(MemoryEvalCheckOutcome(
        ...
        # =========================================================================
            ...
            is_m1_eligible = invalid_source in ("VERIFIED_WORKFLOW", "DETERMINISTIC_DERIVATION", "HUMAN_CONFIRMED")
            checks.append(MemoryEvalCheckOutcome(
        ...
        # =========================================================================
            ...
            import re
            secret_pattern = re.compile(r"(?i)(bearer\s+[a-z0-9_\-\.]{20,}|sk_live_[a-z0-9_\-]{16,})")
        ...
        # =========================================================================
            ...
            checks.append(MemoryEvalCheckOutcome(
                ...
                bound_exceeded,
                f"Pydantic validator blocked limit=50",
            ))
